...
ActiveRecord::Schema[8.0].define(version: 2025_11_24_130130) do
  ...
  create_table "solid_errors_occurrences", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.bigint "error_id", null: false
    t.text "backtrace"
    t.text "context", size: :long, collation: "utf8mb4_bin"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["error_id"], name: "fk_rails_bab819a82b"
  end
