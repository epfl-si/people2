...
module ProfilesHelper
  ...
  def single_text_field(form, attr, label: nil, help: nil, extracls: "", tabindex: nil, data: nil)
    a = attr.to_sym
    tlabel = label || ".#{attr}"
    ...
    form_group(help: help, extracls: extracls) do
      form.label(t(tlabel)) +
        form.text_field(
          a, placeholder: true, class: "form-control", "aria-describedby": ahelp, tabindex: tabindex, data: data
        )
    end
  end
